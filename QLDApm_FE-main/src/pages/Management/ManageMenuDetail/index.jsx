  ...
  const handleSubmit = async () => {
    if (data.dishId) {
      ...
      try {
        ...
        await axios.put(`https://htk.sflavor-demo-app-backend.io.vn/api/v1/dish/${data.dishId}`, {
          ...rest,
      ...
      try {
        for (let i = 0; i < dataSource.length; i++) {
          ...
          await axios.post('https://htk.sflavor-demo-app-backend.io.vn/api/v1/dish', pushedData)
        }
    ...
    const fetchData = async () => {
      try {
        const [categoriesResponse, dishResponse] = await Promise.all([
          axios.get('https://htk.sflavor-demo-app-backend.io.vn/api/v1/categories'),
          axios.get(`https://htk.sflavor-demo-app-backend.io.vn/api/v1/dish/${pathname[4]}`),
        ])

        setCategories(categoriesResponse.data.data[0])
        setData(dishResponse.data.data[0])
      } catch (error) {
