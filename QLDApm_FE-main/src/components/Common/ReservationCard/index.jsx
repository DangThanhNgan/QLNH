...
const ReservationCard = () => {
  ...
  const handleNavPrev = (e) => {
    navigate(
      `/home/reservation/booking?day=${e.date.day}?month=${e.date.month}?year=${e.date.year}?tT=${e.tableType}?tC=${e.tableCount}`
    )
  }
  ...
  const handleBooking = () => {
    ...
    navigate(
      `/home/reservation/booking?day=${date.day}?month=${date.month}?year=${date.year}?tT=${tableType}?tC=${tableCount}`
    )
  }
